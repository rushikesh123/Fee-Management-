...
<head>
   ...
   <link rel="stylesheet" href="css/bootstrap-theme.min.css">
    ...
    <nav class="navbar navbar-default">
        ...
        <h3 style="text-align:center;">Admin Login Here<br></h3>
        </div>
    </nav>
	...
	<div class="jumbotron">
	 	...
	 	<input type="email" placeholder="enter your email" name="adm_email" autocomplete="off">
	 	<input type="password" placeholder="enter your password" name="adm_password">
	 	<input type="reset">
